  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden px-4 py-8 bg-black text-white">
      ...
      <style jsx>{`
        ...
        @keyframes neonGlow {
          0%, 100% { filter: drop-shadow(0 0 1px #52ff00) drop-shadow(0 0 2px #52ff00); }
          50% { filter: drop-shadow(0 0 2px #52ff00) drop-shadow(0 0 3px #52ff00); }
        }
        .neon-logo {
      ...
      {!selectedStore ? (
        <div className="text-center relative z-10 w-full max-w-md" style={{ animation: 'fadeIn 1.5s forwards' }}>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Button className="store-button w-full sm:w-48 bg-[#c500fd] text-[#000000] hover:bg-[#c500fd]" onClick={() => handleStoreSelect('main')}>
              Explorar Tienda
            </Button>
          </div>
        </div>
        ...
        <div className="text-center w-full max-w-md p-4 relative z-10" style={{ animation: 'fadeIn 1.5s forwards' }}>
          ...
          <div className="mb-6 text-left">
            ...
            <Button className="social-button mt-4 w-full text-xs sm:text-base bg-[#c500fd] text-[#000000] hover:bg-[#c500fd]" onClick={handleCopyToClipboard}>
              Copiar datos de transferencia
            </Button>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-2 mb-6">
            <Button 
              className="social-button text-xs sm:text-base bg-[#c500fd] text-[#000000] hover:bg-[#c500fd]"
      ...
      <Button
        className="absolute top-4 right-4 bg-[#c500fd] text-[#000000] hover:bg-[#c500fd] px-2 py-1 sm:px-4 sm:py-2 rounded-full transition-all z-20 text-xs sm:text-base"
